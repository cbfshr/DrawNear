...
public class DrawingManager {
	...
	public void getNearbyDrawings(ParseGeoPoint location, int numberOfDrawings) {
		...
		try {
			...
			Log.i("MAIN", "Retreived from Parse: " + parseObjectList.size()
					+ " drawings within " + radius + " km");
	...
	public boolean saveDrawingToRemoteServer(DrawingItem d,
		...
		if (d.getPrivacy() != null) {
			...
			case FRIENDS:
				...
				List<ParseUser> friends = (List<ParseUser>) d.getCreator().get(
						("friendsList"));
				if (friends != null) {
