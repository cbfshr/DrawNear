...
public class NearbyActivity extends Activity implements IGPSActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		noContent
				.setText("There are no drawings nearby.\nMake one and be the first!");
		...
		if (drawingAdapter == null) {
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					DrawingItem drawing = (DrawingItem) parent
							.getItemAtPosition(position);
					Intent intent = new Intent(NearbyActivity.this,
							DisplayPostActivity.class);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		MenuItem drawingComplete = menu.add(0, MENU_REFRESH_LIST, Menu.NONE,
				R.string.refresh).setIcon(R.drawable.ic_refresh);
			...
			public void done(byte[] data, ParseException e) {
				if (e == null) {
					...
					DrawingManager.getInstance().getCurrentNearbyDrawings()
							.get(drawingKey).setThumbnail(thumbBitmap);
