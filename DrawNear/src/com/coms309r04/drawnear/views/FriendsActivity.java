...
import com.coms309r04.drawnear.R.layout;
import com.coms309r04.drawnear.R.menu;
...
public class FriendsActivity extends Activity {
	...
	public void addFriend(View v) {
		String username = ((EditText) findViewById(R.id.add_friend_username))
				.getText().toString();
		...
		query.findInBackground(new FindCallback<ParseUser>() {
			...
			public void done(List<ParseUser> users, ParseException e) {
				if (e == null) {
					...
					Toast.makeText(FriendsActivity.this,
							"Error adding friend.", Toast.LENGTH_SHORT).show();
				}
	...
	private void getFriends() {
		...
		List<ParseUser> friends = (List<ParseUser>) ParseUser.getCurrentUser()
				.get("friendsList");
